...
public class AlbumActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView bottomMusicName,bottomMusicSinger;//歌曲名字、歌手
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Album album = MusicUtils.getAlbumList().get(position);
        ...
        adapter = new SongsAdapter(AlbumActivity.this,album.getSongList());
